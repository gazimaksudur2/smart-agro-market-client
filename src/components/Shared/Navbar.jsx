        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            ...
            <Link to="/" className="flex-shrink-0 flex items-center">
              <span className="text-2xl font-display font-bold text-primary-600">SmartAgro</span>
              <span className="ml-1 text-2xl font-display font-bold text-gray-700">Connect</span>
            </Link>
