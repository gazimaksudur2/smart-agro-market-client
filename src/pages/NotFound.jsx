    ...
    <div className="min-h-screen flex flex-col bg-gray-50 pt-16 pb-12">
      ...
      <footer className="flex-shrink-0 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
        <nav className="flex justify-center space-x-4">
          ...
          <Link to="/products" className="text-sm font-medium text-gray-500 hover:text-gray-600">
            Products
          </Link>
          <span className="inline-block border-l border-gray-300" aria-hidden="true" />
          <a href="mailto:support@smartagroconnect.com" className="text-sm font-medium text-gray-500 hover:text-gray-600">
            Contact Support
          </a>
        </nav>
      </footer>
