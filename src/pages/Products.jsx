...
export default function Products() {
  ...
  const cropTypeOptions = cropTypes?.map(type => ({
    value: type,
    label: type
  })) || [];
    ...
    <div className="bg-gray-50 min-h-screen">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-col md:flex-row">
          {/* Filters sidebar */}
          <div className={`md:block md:w-64 md:mr-8 ${showFilters ? 'block' : 'hidden'}`}>
            <div className="bg-white p-4 rounded-lg shadow-sm mb-4">
              ...
              <div className="mb-4">
                ...
                <Select
                  ...
                  className="text-sm"
                  value={filters.cropType ? { value: filters.cropType, label: filters.cropType } : null}
                  onChange={(option) => setFilters({ ...filters, cropType: option?.value || '' })}
                />
              </div>
              ...
              <div className="mb-4">
                <label className={`block text-sm font-medium ${filters.region ? 'text-gray-700' : 'text-gray-400'} mb-1`}>
                  District
                </label>
                <Select
                  ...
                  isClearable
                  placeholder={filters.region ? "All Districts" : "Select Region First"}
                  className="text-sm"
                  value={filters.district ? { value: filters.district, label: filters.district } : null}
                  onChange={(option) => setFilters({ ...filters, district: option?.value || '' })}
                />
              </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm md:hidden">
              <h2 className="text-lg font-medium text-gray-900 mb-2">Sort By</h2>
              <div className="flex flex-col space-y-2">
                <button
                  className={`flex items-center py-2 px-3 text-sm rounded-md ${
                    sortBy === 'latest' ? 'bg-primary-100 text-primary-800' : 'text-gray-700 hover:bg-gray-100'
                  }`}
                ...
                <button
                  className={`flex items-center py-2 px-3 text-sm rounded-md ${
                    sortBy === 'oldest' ? 'bg-primary-100 text-primary-800' : 'text-gray-700 hover:bg-gray-100'
                  }`}
                ...
                <button
                  className={`flex items-center py-2 px-3 text-sm rounded-md ${
                    sortBy === 'price_low' ? 'bg-primary-100 text-primary-800' : 'text-gray-700 hover:bg-gray-100'
                  }`}
                ...
                <button
                  className={`flex items-center py-2 px-3 text-sm rounded-md ${
                    sortBy === 'price_high' ? 'bg-primary-100 text-primary-800' : 'text-gray-700 hover:bg-gray-100'
                  }`}
