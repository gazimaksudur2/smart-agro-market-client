...
export default function Dashboard() {
  ...
  const { data, isLoading, error } = useQuery(['dashboardStats', userRole], async () => {
      ...
      <div className="px-4 sm:px-6 md:px-8">
        ...
        <div className="mt-2 mb-6">
          <p className="text-gray-700">
            Welcome back, <span className="font-medium">{currentUser?.displayName || 'User'}</span>! Here's what's happening with your account.
          </p>
        </div>
        ...
        <div className="mt-8">
          ...
          <div className="mt-3 bg-white shadow overflow-hidden rounded-lg">
            {isLoading ? (
              ...
              <div className="p-6 text-center text-gray-500">Failed to load recent activity</div>
            ) : (
                    ...
                    <div key={index} className="p-4 hover:bg-gray-50">
                      <div className="flex items-center">
                        <div className="flex-shrink-0">
                          <div className={`p-2 rounded-full bg-${activity.color || 'primary'}-100`}>
                            {activity.icon || <FaBoxOpen className={`h-5 w-5 text-${activity.color || 'primary'}-600`} />}
                          </div>
                        </div>
                        <div className="ml-4">
                  ...
                  <>
                    <div className="p-4 hover:bg-gray-50">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          ...
                          <p className="text-sm text-gray-500">You added "Premium Quality Rice" to your products</p>
                        </div>
                        <div className="ml-auto">
                    ...
                    <div className="p-4 hover:bg-gray-50">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          <p className="text-sm font-medium text-gray-900">Monthly summary available</p>
                          <p className="text-sm text-gray-500">Your April 2023 sales summary is now available</p>
                        </div>
                        <div className="ml-auto">
